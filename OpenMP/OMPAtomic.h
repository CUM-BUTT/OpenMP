...
public:
	Atomic(double* a, double* b, int thread_count, int arr_count) :OMP(a, b, thread_count, arr_count) {	}
	Atomic(int thread_count, int arr_count) :OMP(thread_count, arr_count) {	}
